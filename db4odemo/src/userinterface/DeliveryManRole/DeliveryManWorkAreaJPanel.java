...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        refreshJButton.setFont(new java.awt.Font("Tamil MN", 1, 12)); // NOI18N
        ...
        btnConfirm.setFont(new java.awt.Font("Tamil MN", 1, 12)); // NOI18N
        ...
        add(btnConfirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 300, 150, 35));

        lblMarkDeli.setBackground(new java.awt.Color(204, 255, 255));
        lblMarkDeli.setFont(new java.awt.Font("Tamil MN", 1, 12)); // NOI18N
        lblMarkDeli.setForeground(new java.awt.Color(0, 51, 51));
        lblMarkDeli.setText(" Enter Comments & Mark Delivery Complete : ");
        add(lblMarkDeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 365, -1, 20));

        txtComments.setFont(new java.awt.Font("Ebrima", 1, 12)); // NOI18N
        txtComments.setForeground(new java.awt.Color(0, 51, 51));
        add(txtComments, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 357, 150, 30));

        btnDeliComplete.setBackground(new java.awt.Color(204, 255, 255));
        btnDeliComplete.setFont(new java.awt.Font("Tamil MN", 1, 12)); // NOI18N
        btnDeliComplete.setForeground(new java.awt.Color(0, 51, 51));
        btnDeliComplete.setText("Delivery Completed");
        ...
        add(btnDeliComplete, new org.netbeans.lib.awtextra.AbsoluteConstraints(517, 357, 150, 33));

        lblDeliDetails.setBackground(new java.awt.Color(204, 255, 255));
        lblDeliDetails.setFont(new java.awt.Font("Tamil MN", 1, 18)); // NOI18N
        lblDeliDetails.setForeground(new java.awt.Color(0, 51, 51));
        lblDeliDetails.setText("Delivery Details");
        add(lblDeliDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 40, 210, -1));
